...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById("item_id").addEventListener("change", function () {
    ...
    if (itemId !== "") {
        ...
        console.log("Fetching units from:", url); // Debugging
        ...
        fetch(url)
            ...
            .then(data => {
                ...
                populateGridBody(data);
            })
            .catch(error => {
                console.error("Error fetching unit data:", error);
                gridBody.innerHTML = `<tr><td colspan="4">Error loading data.</td></tr>`;
            });
    } else {
        gridBody.innerHTML = `<tr><td colspan="4">Please select an item.</td></tr>`;
    }
});

    function populateGridBody(data) {
        ...
        if (data.length > 0) {
            ...
            gridBody.innerHTML = `<tr><td colspan="4">No units available.</td></tr>`;
        }
    }
});
    </script>
