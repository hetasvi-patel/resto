...
{   
     ...
     public function pageSearch()
    {
        ...
        if(COMPANY_ID!=ADMIN_COMPANY_ID) 
            ...
            $where_condition=" 1=1 ";
        $sql="CAll ".$database_name."_search_detail('t.state_name, t2.country_name as val2, t.gst_code, t.modified_date, u2.person_name as modified_by, t.state_id','tbl_state_master t INNER JOIN tbl_country_master t2 ON t.country_id=t2.country_id LEFT JOIN tbl_user_master u2  ON t.modified_by=u2.user_id ','{$where_condition}')";
        echo "<!-- Filter row -->
                ...
                $k=0;
                            ...
                            <input type=\"text\" class=\"form-control \" placeholder=\"Search Country Name\" data-index=\"".$k."\" />
                             ...
                             $k++;echo "<div class=\"col-auto\">
                            <input type=\"text\" class=\"form-control \" placeholder=\"Search Gst Code\" data-index=\"".$k."\" />
                        </div>";
                             $k++;echo "<div class=\"col-auto\">
