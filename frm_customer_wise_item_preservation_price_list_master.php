...
$(document).ready(function () {
    // Listen for changes in either item_id or customer_id dropdown
    $('#item_id, #customer_id').on('change', function () {
        ...
        if (itemId && customerId) {
            ...
            // Fetch data with both item and customer ID
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#gridContainer').html(response); // Update the grid
                },
                error: function () {
                    alert('Error fetching data. Please try again.');
                    $('#gridContainer').html('<div class="alert alert-danger">Error loading units.</div>');
                }
            });
        } else {
            $('#gridContainer').html('<div></div>');
        }
    });
});
</script>
